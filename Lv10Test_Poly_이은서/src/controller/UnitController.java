...
public class UnitController {
	...
	private UnitController() {
		this.players.add(new UnitPlayer("전사",1000,60,50));
		this.players.add(new UnitPlayer("법사",500,90,40));
		this.players.add(new UnitPlayer("힐러",700,50,40));
	}
